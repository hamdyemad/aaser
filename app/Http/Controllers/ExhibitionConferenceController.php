...
use App\Http\Requests\AddVisitorRequest;
...
class ExhibitionConferenceController extends Controller
{
    ...
    {
        $ExhibitionConference = ExhibitionConference::with('phone','email','image','file','visitor','participant','provider')->findorFail($id);
        return response()->json([
            'status' => 'Success',
            'data' => new ExhibitionConferenceResource($ExhibitionConference),
            'message' => 'Exhibition Conference Return Successfully',
        ]);
    }
    ...
    public function all(Request $request)
    {
        ...
        $ExhibitionConference = ExhibitionConference::with('phone','email','image','file','visitor','participant','provider')->OrderBy('id','desc')->paginate($item);
        return response()->json([
            'status' => 'Success',
    ...
    public function addVisitor(AddVisitorRequest $request)
    {
        ...
        return response()->json([
            'status' => 'Success',
            'data' => new RewardRequestResource(RewardRequest::with('visitorExhibitionConference','user')->findorFail($reward_request->id)),
            'message' => 'Visitor And Reward Request Added Successfully',
        ]);
    }
    ...
    public function addParticipant(AddParticipantRequest $request)
    {
        ...
        return response()->json([
            'status' => 'Success',
            'data' => new RewardRequestResource(RewardRequest::with('participantExhibitionConference','user')->findorFail($reward_request->id)),
            'message' => 'Participant And Reward Request Added Successfully',
        ]);
    }
}
