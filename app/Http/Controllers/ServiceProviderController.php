...
class ServiceProviderController extends Controller
{
    ...
    public function all(Request $request)
    {
        ...
        if($specialized_provider) {
            $service_providers->where('specialized_provider', $specialized_provider);
        }
        if($specialized_type) {
            $service_providers->where('specialized_type', $specialized_type);
        }

        $service_providers = $service_providers->paginate($item);
        return response()->json([
            'status' => 'Success',
