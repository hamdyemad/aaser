...
class RewardController extends Controller
{
    ...
    {
        $requests = RewardRequest::with('reward','user','provider','requestGuide','requestStockPoint','requestReplacePoint','requestTouriste','requestActivity','visitorExhibitionConference','participantExhibitionConference')
